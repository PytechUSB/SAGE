...
urlpatterns = patterns('',
    ...
    url(r'^validar_reserva/(?P<link>\mover_reserva|validar_billetera/cancelar_reserva|validar_billetera/recarga_mover)/$', views.validar_reserva, name = 'validar_reserva'),
