...
urlpatterns = patterns('',
    ...
    #url(r'^(?P<_id>\d+)/$', views.estacionamiento_puestos, name = 'estacionamiento_puestos'),
    ...
    url(r'^(?P<_id>\d+)/parametrizar$', views.estacionamiento_detail2, name = 'estacionamiento_detail2'),
