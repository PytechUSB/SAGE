...
urlpatterns = patterns('',
    ...
    url(r'^(?P<_id>\d+)/tarifa-particular$', views.estacionamiento_particulares, name = 'estacionamiento_particulares'),
    url(r'^(?P<_id>\d+)/tarifas$', views.estacionamiento_tarifas, name = 'estacionamiento_tarifas'),
    url(r'^(?P<_id>\d+)/tarifa-moto$', views.estacionamiento_motos, name = 'estacionamiento_motos'),
    url(r'^(?P<_id>\d+)/tarifa-camion$', views.estacionamiento_camiones, name = 'estacionamiento_camiones'),
